...
//Safety loop guard
#ifndef CLIENT_NETWORK_GAME_MONTECARLO_C
#define CLIENT_NETWORK_GAME_MONTECARLO_C
...
{
    int fd = 1;
    int e = define_connection(CHESS_MA2_NETWORK_ADDRESS, CHESS_MA2_NETWORK_PORT_GAME_MONTECARLO, &fd);
    if (e != 0)
        return NULL;
